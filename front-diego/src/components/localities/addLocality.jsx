// src/components/panel/AddLocality.jsx
import React, { useMemo, useRef, useState } from "react";
import { useDispatch } from "react-redux";
import { createLocality, fetchLocalities } from "../../redux/localities.slice";

export default function AddLocality({
  children = "+ Agregar localidad",
  onCreated,
  onClick,
}) {
  ...
  const createOne = async () => {
    await dispatch(createLocality({ name: name.trim() })).unwrap();
          ...
          <div className="modal-center">
            <div className="modal-card p-6">
              ...
              <div className="flex items-center justify-between mb-3">
                <h3 className="modal-title">Agregar localidad</h3>
                <button
                  className="close-btn"
                  onClick={() => !loading && closeModal()}
                  aria-label="Cerrar"
